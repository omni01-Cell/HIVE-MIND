...
export const filterDB = {
     ...
     */
    async addFilter(groupJid, keyword, contextRule, severity = 'warn', createdBy) {
     ...
     */
    async updateVariants(filterId, variants) {
        if (!supabase) throw new Error("Supabase non connecté");
...
export const whitelistDB = {
     ...
     */
    async add(groupJid, userJid, addedBy, reason = '') {
        if (!supabase) throw new Error("Supabase non connecté");
     ...
     */
    async isWhitelisted(groupJid, userJid) {
...
export const warningsDB = {
     ...
     * Ajoute un warning
     */
    async add(groupJid, userJid, reason, filterId = null) {
        if (!supabase) throw new Error("Supabase non connecté");
...
export const configDB = {
     ...
     */
    async setFilteringActive(groupJid, active) {
     ...
     */
    async setAutoBan(groupJid, enabled) {
