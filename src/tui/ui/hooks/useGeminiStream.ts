...
export const useGeminiStream = (
    ...
    // eslint-disable-next-line complexity -- Large useEffect managing tool lifecycle
    useEffect(() => {
        ...
        tc.status === 'cancelled'
                ...
                // This lookahead logic is a tactical UI fix to prevent parallel agents
    ...
    const submitQuery = useCallback(
        async (
            ...
            !options?.isContinuation
                    ...
                    const resolvedPromptId = prompt_id || config.getSessionId() + '########' + getPromptCount();
                    return promptIdContext.run(resolvedPromptId, async () => {
