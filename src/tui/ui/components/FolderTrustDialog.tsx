...
const renderDiscoveryContent = (
    discoveryResults: FolderDiscoveryResults | null | undefined,
    hasErrors: boolean,
    hasWarnings: boolean,
...
export const FolderTrustDialog: React.FC<FolderTrustDialogProps> = ({
    ...
    const discoveryContent = renderDiscoveryContent(
        discoveryResults, !!hasErrors, !!hasWarnings, !!hasDiscovery, groups
    );
