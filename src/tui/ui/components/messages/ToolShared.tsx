...
export function useFocusHint(
    ...
    shellFocusable && (showFocusHint || userHasFocused);
...
export const FocusHint: React.FC<{
  ...
  shellFocused: boolean;
}> = ({ shouldShowFocusHint, shellFocused }) => {
    ...
    return (
        <Box marginLeft={1} flexShrink={0}>
            <Text color={shellFocused ? theme.ui.focus : theme.ui.active}>
                {shellFocused
