...
function ScrollableList<T>(
    ...
    const smoothScrollState = useRef<{ active: boolean; start: number; from: number; to: number; duration: number; timer: NodeJS.Timeout | null }>({ active: false, start: 0, from: 0, to: 0, duration: 0, timer: null });
