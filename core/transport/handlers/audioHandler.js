...
export class AudioHandler {
     ...
     */
    async processAudioMessage(msg, normalizedMsg) {
    ...
    async _handlePvAudio(msg, normalizedMsg) {
    ...
    async _handleGroupAudio(msg, normalizedMsg) {
    ...
    async _transcribeAudio(msg, fileName) {
        const buffer = await this._downloadAudio(msg);
        if (!buffer) return null;
        return await this._transcribeFromBuffer(buffer, fileName);
    }

    async _transcribeFromBuffer(buffer, fileName) {
