...
export const adminService = {
    ...
    async refresh() {
        ...
        try {
            ...
            adminCache.clear();
            data.forEach(a => adminCache.set(a.jid, a.role || 'moderator'));
     ...
     */
    async addAdmin(jid, name = null, role = 'moderator') {
