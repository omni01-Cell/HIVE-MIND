...
1. `BotCore` - 40 edges
2. `BaileysTransport` - 38 edges
3. `ProviderRouter` - 37 edges
4. `TransportManager` - 25 edges
5. `DatabaseMonitor` - 24 edges
6. `PermissionManager` - 22 edges
7. `BrowserService` - 22 edges
8. `BotIdentity` - 22 edges
9. `SchedulerHandler` - 19 edges
...
Cohesion: 0.21
Nodes (4): ExplicitPlanner, loadJsonLibraries(), PLAN_SCHEMA, planner
...
Cohesion: 0.3
Nodes (3): AudioHandler, msg, result
...
Cohesion: 0.22
Nodes (7): bigHistory, bigOutput, bigToolOutput, hasTruncated, history, result, smallHistory
...
Cohesion: 0.25
Nodes (7): cost, duration, fallbackTracker, record, record2, summary, tracker2

### Community 74 - "Community 74"
Cohesion: 0.25
Nodes (6): chatEntries, disallowedSmallChatModels, ModelsConfig, Recipe, serviceEntries, violations
